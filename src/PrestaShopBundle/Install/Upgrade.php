...
namespace PrestaShopBundle\Install {
    ...
    class Upgrade
    {
        ...
        private function cleanCache()
        {
            ...
            if (file_exists(_PS_CACHE_ROOT_DIR_ . '/dev/class_index.php')) {
                unlink(_PS_CACHE_ROOT_DIR_ . '/dev/class_index.php');
            }
            if (file_exists(_PS_CACHE_ROOT_DIR_ . '/prod/class_index.php')) {
                unlink(_PS_CACHE_ROOT_DIR_ . '/prod/class_index.php');
            }
